...
if ( $_SERVER['REQUEST_METHOD'] == 'GET'){
    // GET method: Mostrar los datos del Maestro
    ...
    $sql = "SELECT * FROM maestro WHERE id=$id";
    ...
    // POST method: Actualizar los datos del Maestro
    $id = $_POST["id"];
    ...
    do{
        if ( empty($matricula) || empty($nombres) || empty($apellidos) || empty($materia) || empty($email) || empty($contrasena) ) {
        ...
        $sql = "UPDATE maestro " .
                "SET matricula = '$matricula', nombres = '$nombres', apellidos = '$apellidos', materia = '$materia', email = '$email', contrasena = '$contrasena' " .
                "WHERE id = $id";
        ...
        $successMessage = "Mestro actualizado correctamente";
...
<body>
    <header class="cabecera">
        <div>
            ...
            <nav class="navbar">
                <h1 class="tituloHeader">Editar Maestro</h1>
                <ul class="nav-links">
    ...
    <div class="container">
        <div class="form-box" id="login-form">
            <form method="post">
                ...
                <h3>Materia que Imparte</h3>
                <input type="text" name="materia" placeholder="Materia que Imparte" value = "<?php echo $materia; ?>">
                <h3>Email</h3>
                ...
                <div class="button-group">
                    ...
                    <a href="crud_maestros.php" class="btn btn-cancel">Cancelar</a>
                </div>
